...
var CarSound , MenuAudio , ClickAudio
...
function preload() {
  ...
  menu_img = loadImage ("Images/Menu Wallpaper.jpg");

  CarSound = loadSound ("Audios/car1.mp3");
  ClickAudio = loadSound ("Audios/car2.mp3");
  MenuAudio = loadSound("Audios/music.mp3");
}
